...
=== Content Fleksibel
=== Jalur Frontend Engineer
[cols="1,3",options="header"]
|===
|Materi |Penjelasan
|Fundamental Frontend |Pengenalan konsep dasar pengembangan antarmuka pengguna serta peran frontend dalam sebuah sistem aplikasi.
|Dasar HTML, CSS, dan JavaScript |Pemahaman struktur halaman web, pengaturan tampilan, serta interaksi pengguna menggunakan teknologi dasar web.
|UI/UX & Usability |Pemahaman prinsip desain antarmuka yang efektif, mudah digunakan, dan berorientasi pada pengalaman pengguna.
|===

=== Jalur Backend Engineer
[cols="1,3",options="header"]
|===
|Materi |Penjelasan
|Fundamental Backend |Pengenalan konsep kerja server, alur data, serta peran backend dalam mendukung aplikasi.
|Pemrograman Backend |Penerapan logika pemrograman sisi server untuk memproses data dan menjalankan fungsi aplikasi.
|Database & API |Pemahaman pengelolaan data serta komunikasi antar sistem menggunakan Application Programming Interface (API).
|===

=== Jalur System Engineer
[cols="1,3",options="header"]
|===
|Materi |Penjelasan
|Linux OS |Pengenalan dan penggunaan sistem operasi berbasis open-source untuk kebutuhan server dan pengembangan sistem.
|Jaringan Komputer |Pemahaman dasar konsep jaringan, protokol komunikasi, dan pertukaran data.
|Git, GitHub & CI/CD |Pemahaman pengelolaan versi kode sumber, kolaborasi tim pengembangan, serta otomatisasi proses integrasi dan distribusi aplikasi untuk menjaga konsistensi, kualitas, dan keandalan sistem.
|===

==== Materi Pendukung Umum
[cols="1,3",options="header"]
|===
|Materi |Penjelasan
