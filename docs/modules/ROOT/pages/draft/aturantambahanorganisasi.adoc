...
. Pemberian Sanksi III (pemecetan) diberikan oleh BPH atas Persetujuan oleh DPO atau Badan Pendiri.
...
=== Pasal 11 Kartu Tanda Anggota(KTA)

.. Kartu Tanda Anggota (KTA) dapat digunakan pada saat aktivitas keorganisasian.
.. Kartu Tanda Anggota (KTA) dapat digunakan anggota aktif, anggota luar biasa, badan pendiri, dan badan pengawas.
...
Badan Pengurus Harian (BPH) yang tidak mengikuti keseluruhan rangkaian kegiatan Musyawarah besar (MUBES) yang alasannya tidak dapat di pertanggung jawabkan tidak diperkenankan mengikuti prosesi pelantikan anggota baru pada periode yang sedang berjalan.
